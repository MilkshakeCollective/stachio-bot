		...
		const embed = new EmbedBuilder()
			...
			.setDescription(
				[
					...
					(await t(interaction.guild!.id, 'commands.utility.help.embed._18')) +
						` ${client.users.cache.get('711712752246325343')?.username} (${client.users.cache.get('711712752246325343')?.id})`,
					'',
